          ...
          <div className="mb-4">
              ...
              <ul className="list-disc list-inside">
                  <li className="text-sm">
                      Designed and developed a comprehensive "Alerts" page with
                      dynamic table views, service entry tracking, and tab bar
                      badge integration, significantly improving user engagement
                      and response times.
                  </li>
                  <li className="text-sm">
                      Implemented a two-stage loading and caching mechanism,
                      drastically reducing load times for dashboards and
                      property details, and eliminating redundant network calls
          ...
          <div className="mb-4">
              ...
              <ul className="list-disc list-inside">
                  <li className="text-sm">
                      ...
                      development courses, covering essential technologies such
                      as HTML, CSS, JavaScript, WordPress, PHP, and Figma.
                  </li>
                  <li className="text-sm">
                      Led engaging weekly lab sessions, guiding students through
                      complex homework assignments and classwork, fostering a
                      deeper understanding of web development principles and
          ...
          <div>
              ...
              <ul className="list-disc list-inside">
                  <li className="text-sm">
                      ...
                      launch of Zwicoat's medical technology website, leveraging
                      React, React Router, Tanstack Query, HTML, CSS, and
                      JavaScript to deliver a modern and functional platform.
                  </li>
                  <li className="text-sm">
                      Managed project timelines and maintained high code quality
                      through diligent use of GitHub for version control and
                      collaborative development, ensuring timely delivery and
                      long-term maintainability.
                  </li>
                  <li className="text-sm">
                      Engineered a fully responsive website layout,
                      significantly improving user experience across all devices
                      and optimizing for search engine discoverability (SEO) to
